...
using fandaq.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace fandaq.PublicWebGateway;

[DependsOn(
    typeof(fandaqSharedHostingGatewaysModule)
)]
public class fandaqPublicWebGatewayModule : AbpModule
{
