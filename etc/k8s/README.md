...
Necessary helm charts are created under `etc/k8s/fandaq` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 angular.fandaq.dev
127.0.0.1 fandaq.dev
127.0.0.1 authserver.fandaq.dev
127.0.0.1 identity.fandaq.dev
127.0.0.1 administration.fandaq.dev
127.0.0.1 product.fandaq.dev
127.0.0.1 saas.fandaq.dev
127.0.0.1 gateway-web.fandaq.dev
127.0.0.1 gateway-public.fandaq.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `fandaq` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://fandaq-st-public-web for public and
   https://fandaq-st-angular for the back-office application
