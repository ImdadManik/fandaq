...
namespace fandaq.Shared.Hosting.Microservices;
...
public class fandaqSharedHostingMicroservicesModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            .AddDataProtection()
            .SetApplicationName("fandaq")
            .PersistKeysToStackExchangeRedis(redis, "fandaq-Protection-Keys");
