...
docker build -f Dockerfile.local -t mycompanyname/fandaq-db-migrator:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-service-identity:$version .

### ADMINISTRATION-SERVICE
Write-Host "*** BUILDING ADMINISTRATION-SERVICE ***" -ForegroundColor Green
Set-Location $administrationServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-service-administration:$version .

### SAAS-SERVICE
Write-Host "*** BUILDING SAAS-SERVICE ***" -ForegroundColor Green
Set-Location $saasServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-service-saas:$version .

### PRODUCT-SERVICE
Write-Host "*** BUILDING PRODUCT-SERVICE ***" -ForegroundColor Green
Set-Location $productServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-service-product:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-gateway-web:$version .

### PUBLICWEB-GATEWAY
Write-Host "*** BUILDING WEB-PUBLIC-GATEWAY ***" -ForegroundColor Green
Set-Location $webPublicGatewayFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-gateway-web-public:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-app-authserver:$version .

### PUBLIC-WEB
Write-Host "*** BUILDING WEB-PUBLIC ***" -ForegroundColor Green
Set-Location $publicWebFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t mycompanyname/fandaq-app-public-web:$version .
### Angular WEB App
if (Test-Path -Path $angularAppFolder) {
    ...
    # ng build --prod
    npm run build:prod
    docker build -f Dockerfile.local -t mycompanyname/fandaq-app-angular:$version .
}
