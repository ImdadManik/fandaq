...
namespace fandaq.PublicWeb.Menus;

public class fandaqPublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public fandaqPublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<fandaqResource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                fandaqPublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                fandaqPublicWebMenus.ProductPage,
                "Products",
                "/Products",
